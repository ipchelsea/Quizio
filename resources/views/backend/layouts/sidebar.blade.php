                    ...
                    <div class="span3">
                        <div class="sidebar">
                            ...
                            <li><a href="{{route('user.create')}}"><i class="menu-icon icon-bullhorn"></i>Create User </a>
                                ...
                                <li><a href="{{route('user.index')}}"><i class="menu-icon icon-inbox"></i>View All Users <b class="label green pull-right">
                                    </b> </a></li>
                            </ul>
                            ...
                            <li><a href="{{route('user.exam')}}"><i class="menu-icon icon-bullhorn"></i>Assign Quiz </a>
                                ...
                                <li><a href="{{route('view.exam')}}"><i class="menu-icon icon-inbox"></i>View User Quiz <b class="label green pull-right">
                                    </b> </a></li>
                            </ul>
